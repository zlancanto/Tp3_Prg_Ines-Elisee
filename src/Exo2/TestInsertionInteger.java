...
public class TestInsertionInteger {
	...
	public static final String FICHIER1 = "fichier1.txt";
	public static final String FICHIER2 = "fichier2.txt";
	...
	public void testInsertionInteger3() {
		...
		ourArray.insert(36);
		int[] tab = { 36 };
		assertTrue(ourArray.toString(), equalIntegerArrays(ourArray.toArray(), tab));
	}
	...
	public void testInsertionInteger4() throws FileNotFoundException {
		...
		assertTrue("courte liste, test 1", equalIntegerArrays(ourArray.toArray(), realArray));
		scanner.close();
	}
	...
	public void testInsertionInteger5() throws FileNotFoundException {
		...
		ourArray.createArray(scanner);
		ourArray.insert(5);
		assertTrue("courte liste, test 2, un ajout de plus", equalIntegerArrays(ourArray.toArray(), realArray));
		scanner.close();
	}
	...
	public void testInsertionInteger6() throws FileNotFoundException {
		...
		ourArray.insert(5);
		ourArray.insert(5);
		assertTrue("courte liste, test 3, m�me ajout une 2e fois", equalIntegerArrays(ourArray.toArray(), realArray));
		scanner.close();
	}
	...
	public void testInsertionInteger7() throws FileNotFoundException {
		...
		ourArray.insert(5);
		ourArray.insert(6);
		assertTrue("courte liste, test 4, un ajout de plus", equalIntegerArrays(ourArray.toArray(), realArray));
		scanner.close();
	}
	...
	public void testInsertionInteger9() throws FileNotFoundException {
		...
		InsertionInteger ourArray = new InsertionInteger();
		ourArray.createArray(scanner);
		assertTrue("une longue liste d'entiers avec doublons", equalIntegerArrays(ourArray.toArray(), array));
		scanner.close();
	...
	public void testInsertionInteger10() throws FileNotFoundException {
		...
		ourArray.createArray(scanner);
		ourArray.insert(4);
		assertTrue("insertion dans une liste pleine 1", equalIntegerArrays(ourArray.toArray(), array));
		scanner.close();
